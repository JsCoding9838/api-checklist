...
1. Object with property (string, boolean, number, object, array, method, which will be return a property value)
2. template string. minimum 3 property will be dynamic (nested pbject property, array second element, another property)
